...
async function calculateTraysOnSushiTrain(filePath) {
  ...
  for await (const line of rl) {
    ...
    // Adjustment 1: Added missed scans from 3 hours ago (or 1.5 hours from 4 pm onwards)
    ...
    // Adjustment 2: Added missed scans from 1.5 hours ago (always used from 4 pm onwards)
    ...
    // Applying both the adjustments if any
